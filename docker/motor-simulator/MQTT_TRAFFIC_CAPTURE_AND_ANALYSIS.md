...
|----------------|-----------------|
| ![**Packet 1** (first captured publish)](wireshark_screenshots/Screenshot_2026-06-03_175019.png) | Shows `MotorOut: true`. Capture started after script had already run for a few seconds. |
